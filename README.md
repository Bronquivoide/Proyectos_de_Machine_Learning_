...
* Tan, P.-N., Steinbach, M., & Kumar, V. (2014). Introduction to data mining (2nd ed.). Pearson Education Limited.
* Ng, A., & Ma, T. (2023, June 11). CS229: Machine learning – Lecture notes. Stanford University.
* James, G., Witten, D., Hastie, T., Tibshirani, R., & Taylor, J. (2023). An introduction to statistical learning: With applications in Python (1.ª ed.). Springer.
